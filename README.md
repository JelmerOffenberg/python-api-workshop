...
3. **Run the API Server with Uvicorn and Explore the Documentation**
    - Start the server using `uvicorn main:app --reload` and use the preview button in the Google cloud. If you work on your local machine, you can access the API at `http://localhost:8000`.
